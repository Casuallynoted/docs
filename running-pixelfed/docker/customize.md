...
| INSTANCE_DESCRIPTION                | "Pixelfed - Photo sharing for everyone" | Instance description. |
...
| .env key      | Default |  Description |
| ------------- | :-----------: | :----: |
| MAIL_DRIVER     | "smtp"  | Email driver to use for sending emails. Possible values: smtp, sendmail, mailgun, mandrill, ses, sparkpost, log, array. |
